					...
					<div class="panel-heading">
						...
						<div class="btn-group pull-right btn-group-xs">
							...
							<button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
								...
								<span class="sr-only">Trigger Alt</span>
							</button>
									...
									<div class="tab-pane fade in active edit_profile">
										...
										{!! Form::model($user->profile, ['method' => 'PATCH', 'route' => ['profile.update', $user->name],  'class' => 'form-horizontal', 'role' => 'form', 'enctype' => 'multipart/form-data'  ]) !!}
											...
											<div class="form-group has-feedback {{ $errors->has('theme') ? ' has-error ' : '' }}">
												{!! Form::label('theme', 'theme' , array('class' => 'col-sm-4 control-label')); !!}
												<div class="col-sm-6">
											...
											<div class="form-group has-feedback {{ $errors->has('bio') ? ' has-error ' : '' }}">
												{!! Form::label('bio', 'bio' , array('class' => 'col-sm-4 control-label')); !!}
												<div class="col-sm-6">
											...
											<div class="form-group has-feedback {{ $errors->has('twitter_username') ? ' has-error ' : '' }}">
												{!! Form::label('twitter_username', 'twitter_username' , array('class' => 'col-sm-4 control-label')); !!}
												<div class="col-sm-6">
													{!! Form::text('twitter_username', old('twitter_username'), array('id' => 'twitter_username', 'class' => 'form-control', 'placeholder' => 'twitter_username')) !!}
													<span class="glyphicon glyphicon-pencil form-control-feedback" aria-hidden="true"></span>
											...
											<div class="margin-bottom-2 form-group has-feedback {{ $errors->has('github_username') ? ' has-error ' : '' }}">
												{!! Form::label('github_username', 'github_username' , array('class' => 'col-sm-4 control-label')); !!}
												<div class="col-sm-6">
													{!! Form::text('github_username', old('github_username'), array('id' => 'github_username', 'class' => 'form-control', 'placeholder' => 'twitter_username')) !!}
													<span class="glyphicon glyphicon-pencil form-control-feedback" aria-hidden="true"></span>
											...
											<div class="form-group">
												<div class="col-sm-6 col-sm-offset-4">
													...
													{!! Form::button(
														'<i class="fa fa-fw fa-save" aria-hidden="true"></i> ' . 'submit',
														 array(
															...
															'data-toggle' 		=> 'modal',
															'data-title' 		=> 'modals.edit_user__modal_text_confirm_title',
															'data-message' 		=> 'modals.edit_user__modal_text_confirm_message'
													)) !!}
									...
									<div class="tab-pane fade edit_settings">
										...
										{!! Form::model($user, array('action' => array('ProfilesController@updateUserAccount', $user->id), 'method' => 'PUT', 'id' => 'user_basics_form')) !!}
								            ...
								            <div class="form-group has-feedback row {{ $errors->has('name') ? ' has-error ' : '' }}">
								                ...
								                <div class="col-md-9">
								                  	<div class="input-group">
								                    	{!! Form::text('name', old('name'), array('id' => 'name', 'class' => 'form-control', 'placeholder' => 'username')) !!}
								            ...
								            <div class="form-group has-feedback row {{ $errors->has('email') ? ' has-error ' : '' }}">
								                ...
								                <div class="col-md-9">
								                  	<div class="input-group">
								                    	{!! Form::text('email', old('email'), array('id' => 'email', 'class' => 'form-control', 'placeholder' => 'useremail')) !!}
								            ...
								            <div class="form-group has-feedback row {{ $errors->has('first_name') ? ' has-error ' : '' }}">
								                {!! Form::label('first_name', 'firstname', array('class' => 'col-md-3 control-label')); !!}
								                <div class="col-md-9">
								                  	<div class="input-group">
								                    	{!! Form::text('first_name', NULL, array('id' => 'first_name', 'class' => 'form-control', 'placeholder' => 'firstname')) !!}
								                    	<label class="input-group-addon" for="first_name"><i class="fa fa-fw" aria-hidden="true"></i></label>
								                  	</div>
								            ...
								            <div class="form-group has-feedback row {{ $errors->has('last_name') ? ' has-error ' : '' }}">
								                {!! Form::label('last_name', 'lastname', array('class' => 'col-md-3 control-label')); !!}
								                <div class="col-md-9">
								                  	<div class="input-group margin-bottom-1">
								                    	{!! Form::text('last_name', NULL, array('id' => 'last_name', 'class' => 'form-control', 'placeholder' => 'lastname')) !!}
								                    	<label class="input-group-addon" for="last_name"><i class="fa fa-fw" aria-hidden="true"></i></label>
								                  	</div>
										    ...
										    <div class="form-group row">
											    <div class="col-md-9 col-md-offset-3">
													{!! Form::button(
														'<i class="fa fa-fw fa-save" aria-hidden="true"></i> ' . 'submit Profile',
														 array(
															'class' 		 	=> 'btn btn-success',
															'id' 				=> 'account_save_trigger',
															'disabled'			=> true,
															'type' 			 	=> 'button',
															'data-submit'       => 'submit Profile',
															'data-target' 		=> '#confirmForm',
															'data-modalClass' 	=> 'modal-success',
															'data-toggle' 		=> 'modal',
												...
												{!! Form::model($user, array('action' => array('ProfilesController@updateUserPassword', $user->id), 'method' => 'PUT', 'autocomplete' => 'new-password')) !!}
												    ...
												    <div class="pw-change-container margin-bottom-2">
														...
														<div class="form-group has-feedback row {{ $errors->has('password') ? ' has-error ' : '' }}">
														  	...
														  	<div class="col-md-9">
																{!! Form::password('password', array('id' => 'password', 'class' => 'form-control ', 'placeholder' => 'password', 'autocomplete' => 'new-password')) !!}
												        ...
												        <div class="form-group has-feedback row {{ $errors->has('password_confirmation') ? ' has-error ' : '' }}">
												          	{!! Form::label('password_confirmation', 'pw_confirmation', array('class' => 'col-md-3 control-label')); !!}
												          	<div class="col-md-9">
												              	{!! Form::password('password_confirmation', array('id' => 'password_confirmation', 'class' => 'form-control', 'placeholder' => 'pw_confirmation')) !!}
												...
												<div class="row">
													<div class="col-sm-6 col-sm-offset-3 margin-bottom-3 text-center">
														...
														{!! Form::model($user, array('action' => array('ProfilesController@deleteUserAccount', $user->id), 'method' => 'DELETE')) !!}
														    ...
														    {!! Form::button(
														    	'<i class="fa fa-trash-o fa-fw" aria-hidden="true"></i> ' . 'deleteAccountBtn'),
																array(
